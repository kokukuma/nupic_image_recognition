...
def get_topology_data():
    dataset = {}
    dataset['label_1'] = [ numpy.asarray([[1,0,0],
                                          [1,0,0],
                                          [1,0,0]]),
                           numpy.asarray([[0,1,0],
                                          [0,1,0],
                           ...
                           numpy.asarray([[0,0,1],
                                          [0,0,1],
                                          [0,0,1]])]
    dataset['label_2'] = [ numpy.asarray([[0,0,1],
                                          [0,0,1],
                                          [0,0,1]]),
                           numpy.asarray([[0,1,0],
                                          [0,1,0],
                           ...
                           numpy.asarray([[1,0,0],
                                          [1,0,0],
                                          [1,0,0]])]
    dataset['label_3'] = [ numpy.asarray([[1,1,1],
                                          [0,0,0],
                                          [0,0,0]]),
                           numpy.asarray([[0,0,0],
                                          [1,1,1],
                           ...
                           numpy.asarray([[0,0,0],
                                          [0,0,0],
                                          [1,1,1]])]
    dataset['label_4'] = [ numpy.asarray([[0,0,0],
                                          [0,0,0],
                                          [1,1,1]]),
                           numpy.asarray([[0,0,0],
                                          [1,1,1],
...
def runMyNetwork(network, num=0, learnMode=True):
    ...
    #for label, dataset in get_topology_data().items():
...
if __name__ == "__main__":
    ...
    print
    num, network = runMyNetwork(network, num, learnMode=False)
